...
int[,] myArray; // задаём имя(переменную) массива с типом данных - целые числа
myArray = new int[3,5]; // выделяем объём памяти для массива, задавая кол-во строк и столбцов
// по умолчанию элементы массива нули, если не заданы параметры.
// или можно сразу записать:
int[,] myArray = new int[3,5];
//myArray[0, 2] = 99; // присвоение элементу массива значение 99
//Console.WriteLine(myArray[0, 2]); // вывод/показ элемента массива
// можно задать массив с вложенными данными вручную:
int[,] myArray = new int[3,5] // или int[,] myArray = new int[,] // или int[,] myArray =
{
    {1,4,2,6,9},
    {55,6,88,4,99},
    {9,5,8,3,1}
